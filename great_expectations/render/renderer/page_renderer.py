...
class ExpectationSuitePageRenderer(Renderer):
    ...
    def _render_expectation_suite_notes(cls, expectations: ExpectationSuite) -> TextContent:
        ...
        content += [
            ...
            # "This Expectation suite was first generated by {BasicDatasetProfiler} on {date}, using version {xxx} of Great Expectations.",  # noqa: E501 # FIXME CoP
            # "{name}, {name}, and {name} have also contributed additions and revisions.",
            f"This Expectation suite currently contains {total_expectations} total Expectations across {total_columns} columns.",  # noqa: E501 # FIXME CoP
        ]
